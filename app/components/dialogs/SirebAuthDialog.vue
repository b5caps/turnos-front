...
<template>
  <main class="sireb-shell">
    ...
    <section class="auth-dialog" aria-labelledby="sireb-title">
      <header class="dialog-header"><span class="brand-mark"><img src="/logo%20utn%20blanco.png" alt="Logo UTN"></span><div><p class="eyebrow">Facultad Regional San Francisco</p><h1 id="sireb-title">SIREB</h1><p class="dialog-subtitle">Sistema Integral de Reservas y Espacios de Biblioteca</p></div></header>
      ...
      <footer class="dialog-footer"><span>SIREB · Biblioteca</span></footer>
    </section>
  </main>
</template>
